        ...
        <div class="card">
                    ...
                    <tbody>
                        ...
                        foreach ($request as $row) :
                            if ($row['status_name'] == 'Menunggu Antrean' || $row['status_name'] == 'Sedang Diproses') :
                                ...
                                $statusClass = ($row['status_name'] == 'Menunggu Antrean') ? 'red' : 'yellow'; // Kelas badge
                        ?>
                                <tr>
            ...
            <div class="ui bottom attached tab segment" data-tab="second">
                <table class="display" id="requestTable" style="width: 100%; border-collapse: collapse;">
                    <thead>
                        <tr>
                            <th style="padding: 10px; text-align: left;">No Ticket</th>
                            <th style="padding: 10px; text-align: left;">ID Request</th>
                    ...
                    <tbody>
                        ...
                        foreach ($request as $row) :
                            if ($row['status_name'] == 'Selesai') :
                                $hasCompleted = true;
                                $statusClass = 'green'; // Kelas badge untuk status selesai
                        ?>
                                <tr>
                    ...
                    <div class="content">
                        <form class="ui form" method="post" action="<?php echo site_url('admin/transaksi/process_edit'); ?>">
                            ...
                            <div class="field">
                                ...
                                <input type="text" name="no_ticket" value="<?php echo htmlspecialchars($row['no_ticket']); ?>" placeholder="Masukkan No Ticket" readonly>
                            </div>
                            <div class="field">
                                <label>Kategori</label>
                                <input type="text" value="<?php echo htmlspecialchars($row['category_name']); ?>" placeholder="Pilih Kategori" readonly>
