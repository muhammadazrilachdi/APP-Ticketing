...
<div class="sidebar" style="width: 60px; background-color: #333; color: #fff; position: fixed; height: 100%; transition: width 0.3s;">
    ...
    <a class="nav-link" href="<?php echo site_url('admin/category'); ?>" style="display: flex; align-items: center; justify-content: center; padding: 10px; text-decoration: none; color: #fff;" data-tooltip="Back" data-position="right center" data-inverted="">
